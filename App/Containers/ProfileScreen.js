      ...
      <ImageBackground source={shelf} style={styles.backgroundImage}>
        <KeyboardAvoidingView behavior='position'>
          ...
          <TouchableOpacity stye={{position: "absolute", top: 130}} onPress={() => navigate('CardsScreen', {user})}>
            { user_card === 'blank' ?
          <Text style={{color: 'aqua', fontSize: 40, position: "absolute", top: 130, left: 125, height: 100}}> Upload Card</Text>
          :
          <Image source={{uri: user_card}} style={{position: "absolute", top: 105, left: 145,  width: 125, height: 75}}></Image>
          }
          </TouchableOpacity>
