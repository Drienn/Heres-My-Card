...
import { ScrollView, KeyboardAvoidingView, ImageBackground, StatusBar, View, TouchableOpacity, TextInput, Image, Alert, ListView, NativeModules, NativeAppEventEmitter, Platform, AppState } from 'react-native'
...
class CardsScreen extends Component {
  ...
  componentDidMount() {
    ...
    console.log('this is the BleManager - ', BleManager)
  }
      ...
      <ImageBackground style={styles.backgroundImage}>
        ...
        <GestureRecognizer
          ...
          <Button success rounded style={styles.buttonTwoStyleWithImage}
            onPress={() => this.uploadImage(user.user_card)} ><Text style={{position: 'relative', left: 5}}> Set Primary</Text></Button>
          </View>
